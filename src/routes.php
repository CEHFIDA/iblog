<?php
Route::group(['prefix' => config('adminamazing.path').'/blog', 'middleware' => ['web', 'CheckAccess']], function() {
    Route::get('/', 'selfreliance\iblog\BlogController@index')->name('AdminBlog');
    Route::delete('/{id?}', 'selfreliance\iblog\BlogController@destroy')->name('AdminBlogDelete');
